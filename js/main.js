...
class UI {
    constructor() {
       this._waitingArray = new WaitingArray();
    }
    ...
    addNewPatient() {
      ...
      this._waitingArray.pushPatient(p);
    ...
    callNextPatient() {
      let nextPatient = this._waitingArray.shiftPatient();
      if (nextPatient != null) {
    ...
    updateNumberOfWaitingPatients() {
      let numberOfWaitingPatients = this._waitingArray.getNumberOfWaitingPatients();
